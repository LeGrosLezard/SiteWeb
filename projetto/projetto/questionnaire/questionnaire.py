...
def assoc_grande_categorie(liste_supp):
    """On associe les grande categorie a sa definition"""

    liste = []

    for i in liste_supp:
        for cle, valeur in SPHERE.items():
            if i[0] == cle:
                liste.append([valeur, i[1]])
...
def mise_en_page(liste1, liste2):
    page = ""

    page += "Grande Catégorie \n\n"

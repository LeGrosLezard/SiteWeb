QUESTION = {"1": "Anxiete",
            ...
            "81": "Autodiscipline",
            "82": "",
            "83": "-Curiosite_intellectuelle",
            "84": "Modestie",
            "85": "",
            "86": "-Sens_des_competences",
            "87": "emotions_positives",
            "88": "Conformite",
            "89": "-Sympathie",
            "90": "",
...
NOMBRE = {"Anxiete":4,
        "Sociabilite":8,
        "Imagination":1,
        "Confiance_en_autre":3,
        "Combativite_Recherche_de_resultats":6,
        "Colere_et_hostilite":7,
        "Interets_artistiques":3,
        "Indolence":3,
        "Autodiscipline":4,
        "Morosite_contentement":3,
        "Sens_des_competences":3,
        "Profondeur_des_emotions":3,
        "Altruisme":2,
        "Recherche_de_stimulation":7,
        "Volonte_experimenter":3,
        "Curiosite_intellectuelle ":4,
        "Modestie":4,
        "Circonspection":5,
        "Sensibilite_au_stress":3,
        "Conformite":5,
        "Affectation ":4,
        "Sens_des_responsabilites":4,
        "Amenite":1,
        "Ordre":3,
        "emotions_positives":4,
        "Sympathie":8,
        "Sincerite":1,
        "emotions positives":3,
        "Curiosite intellectuelle":2,
        "Tolerance_a_la_diversite":1,
...
par les événements artistiques et naturels.""",
               ...
               "Profondeur_des_emotions": """{0} sollicitent et perçoivent
facilement leurs propres sentiments. """,
               
                "Volonte_expérimenter": """{0} aime découvrir de nouvelles 
...
Cet aspect de personnalité est un vrai atout.""",
                ...
                "Curiosite_intellectuelle": """{0} appréci de jongler
...
les problèmes, réflexions, puzzles et énigmes de l’esprit.""",
                ...
                "Tolerance_a_la_diversite":  """{0} accepte l’autorité et
préfèrent la stabilité
et la sécurité de la conformité à la tradition.""",
               
                "Sens_des_competences": """Le sens des compétences décrit la confiance
...
l’éthique et des principes stricts.""",
                        ...
                        "Combativite_Recherche_de_resultats": """Les gens qui ont un score 
...
très heureux des résultats qu’ils obtiennent.""",
                        ...
                        "Autodiscipline": """L’autodiscipline, souvent appelée 
...
Elles sont mues par une forte motivation à terminer leur travail.""",
                        ...
                        "Circonspection" : """La circonspection décrit la disposition à réfléchir soigneusement
...
Circonspection sont minutieux et prennent leur temps avant de se décider.""",
                        ...
                        "Amenite" : """Les scores élevés aiment
...
Ils ont tendance à être les meneurs dans les groupes.""",
                        ...
                        "Niveau_activite" : """Les personnes actives mènent une vie
...
sont rapides, ils sont dynamiques, vigoureux et s’impliquent dans de nombreuses activités.""",
                        ...
                        "Recherche_de_stimulation" : """Les scores élevés pour cette
...
Ils ont tendance à prendre des risques et à chercher les frissons.""",
                        ...
                        "Emotions_positives" : """Cette facette mesure les humeurs et
...
l’enthousiasme, l’optimisme et la joie.""",
                        ...
                        "Confiance_en_autre" : """Les personnes à score élevé dans
...
les gens sur leur apparence et sont prompts à pardonner et à oublier.""",
                        ...
                        "Sincerite" : """Les scores élevés pour cette facette ne ressentent
...
relations aux autres et sont dès lors candides, francs et authentiques. """,
                        ...
                        "Altruisme" : """Les gens altruistes trouvent une réelle valorisation
...
les autres est une forme d’auto-accomplissement plutôt que de sacrifice.""",
                        ...
                        "Conformite": """Les scores élevés dans cette facette concernent
...
besoins pour bien s’entendre avec les autres.""",
                        ...
                        "Modestie" : """Les scores élevés sont des
...
pas pour autant de confiance en soi ni d’estime de soi.""",
                        ...
                        "Sympathie" : """Les scores élevés sont des
...
plus allègres ou légers (ces comportements-là étant associés à l’extraversion).""",
                        ...
                        "Affectation": """Par contraste, les scores
...
dotés de bonnes aptitudes sociales mais ils se sentent simplement moins nerveux en société.""",
                        ...
                        "Indolence":  """Les scores bas n’éprouvent pas de besoins fulgurants,
irrésistibles et, par conséquent, ne sont pas tentés par les excès.""",
               
                        "Sensibilite_au_stress": """Les scores bas se sentent
...
DICTEE ="""il était une heure du matin. Une énorme déflagration s'est fait entendre.
